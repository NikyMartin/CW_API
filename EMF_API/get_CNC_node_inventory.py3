...
def getNodeInventory():
    ...
    if lastIndex >= 0:
        ...
        for node in root[1]:
            if is_equipment_list(node):
                ...
                try:
                    ...
                    print("\nNode " + node_name + " has " + str(len(equipment_list)) + " equipments\n")
                    for equipment in equipment_list:
                        ...
                        try:
                            ...
                            serial_number = "NA"
                        node_list.append([equipment_name, equipment_description, equipment_type, product_id, serial_number])
                except Exception as e:
                    print(str(e))
                    exit(1)
        ...
        print(tabulate(sorted(node_list), headers=(['Equipment Name', 'Equipment Description', 'Equipment Type',
